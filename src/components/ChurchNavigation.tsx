    ...
    <div className="flex gap-1 md:gap-2 w-full overflow-x-auto">
      {pages.map(page => (
        <button
          ...
          className={activePage===page.hash? "flex-1 md:w-full text-center py-3 md:py-2.5 px-4 rounded-xl text-[13.8px] md:text-[13.8px] sm:text-sm font-semibold md:font-medium transition-all cursor-pointer whitespace-nowrap bg-brand-sage text-white shadow-md shadow-brand-sage/20 border border-brand-sage":"flex-1 md:w-full text-center py-3 md:py-2.5 px-4 rounded-xl text-[13.8px] md:text-[13.8px] sm:text-sm font-semibold md:font-medium transition-all cursor-pointer whitespace-nowrap text-brand-brown bg-brand-sage/10 border border-brand-sage/15 hover:text-brand-sage hover:bg-brand-sage/20 hover:border-brand-sage"}
        >
          {page.label}
        </button>
      ))}
